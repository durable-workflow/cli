...
from release_plan_contract import (
    CURRENT_PLAN_SCHEMA,
    HISTORICAL_PLAN_DIGESTS,
    HISTORICAL_PLAN_SCHEMA,
    supports_release_plan,
)

SCHEMA = CURRENT_PLAN_SCHEMA
LEGACY_SCHEMA = HISTORICAL_PLAN_SCHEMA
LEGACY_PLAN_DIGESTS = HISTORICAL_PLAN_DIGESTS
...
def validate_plan(plan: Any) -> None:
    ...
    if set(plan) != expected or not supports_release_plan(plan):
