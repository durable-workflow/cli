...
final class ActivityParityFixtureTest extends TestCase
{
    public function test_activity_complete_matches_polyglot_request_fixture(): void
    {
        $fixture = self::fixture('activity-complete-parity.json', 'activity.complete');
        $client = new ActivityParityClient($fixture['response_body']);
        ...
        self::assertSame($semantic['task_id'], $decoded['task_id'] ?? null);
        self::assertSame($semantic['activity_attempt_id'], $decoded['activity_attempt_id'] ?? null);
        self::assertSame($semantic['outcome'], $decoded['outcome'] ?? null);
    }

    public function test_activity_fail_matches_polyglot_request_fixture(): void
    {
        $fixture = self::fixture('activity-fail-parity.json', 'activity.fail');
        $client = new ActivityParityClient($fixture['response_body']);
...
final class ActivityParityClient extends ServerClient
{
