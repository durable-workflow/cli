    ...
    private function waitDiagnosticFindings(?array $debug): array
    {
        return $this->mapDiagnosticList(
            ...
            fn (array $finding): array => $this->compactDiagnostic([
                ...
                'workflow_type' => $finding['workflow_type'] ?? null,
                'workflow_type_match' => $finding['workflow_type_match'] ?? null,
                'activity_type' => $finding['activity_type'] ?? null,
                'activity_execution_id' => $finding['activity_execution_id'] ?? null,
                'active_worker_count' => $finding['active_worker_count'] ?? null,
                'active_worker_limit' => $finding['active_worker_limit'] ?? null,
                'active_workers_truncated' => $finding['active_workers_truncated'] ?? null,
