...
final class WorkflowTerminateParityFixtureTest extends TestCase
{
    public function test_workflow_terminate_matches_polyglot_request_fixture(): void
    {
        $fixture = self::fixture();
        $client = new WorkflowTerminateParityClient();
        ...
        self::assertSame($semantic['reason'], $client->lastBody['reason'] ?? null, 'terminate reason drifted from fixture semantics.');
    }
    ...
    {
        $path = __DIR__.'/../fixtures/control-plane/workflow-terminate-parity.json';
        ...
        self::assertSame('workflow.terminate', $fixture['operation'] ?? null);

        return $fixture;
    }
}

final class WorkflowTerminateParityClient extends ServerClient
{
