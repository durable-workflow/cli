...
[`2.0.0-rc.3`](https://github.com/durable-workflow/cli/releases/tag/2.0.0-rc.3).
Available assets:
...
CLI version `2.0.0-rc.3` is the CLI member of the supported Durable Workflow
`2.0.0-rc.3` product train. It is compatible with servers that advertise
...
```json
{
  "exit_code": 8,
  "compatibility": {
    "cli_version": "2.0.0-rc.3",
    "server_version": "2.0.0-rc.3",
