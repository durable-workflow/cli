...
```bash
curl -fsSL https://durable-workflow.com/install.sh | VERSION=2.0.0-beta.16 sh
```

Release `2.0.0-beta.16` is available from the GitHub release page at
<https://github.com/durable-workflow/cli/releases/tag/2.0.0-beta.16>. Replace the
...
- 2.0.0-beta.16 — Advanced the synchronized Durable Workflow 2.0 product
...
- 2.0.0-beta.6 — Advanced the synchronized Durable Workflow 2.0 product
  train for the reliable packaged Waterline service release.
- 2.0.0-beta.5 — Advanced the synchronized Durable Workflow 2.0 product
  train for the unified embedded and service operator release.
- 2.0.0-beta.4 — Advanced the synchronized Durable Workflow 2.0 product
  train with exact prerelease release validation.
